...
const WHY_CARDS = [
  { icon: '🧠', title: 'ביטחון עצמי', text: 'נערות מצליחות יותר כשלומדות בסביבה ללא שיפוטיות מגדרית.' },
  { icon: '🌍', title: 'שינוי חברתי', text: 'הנערות לומדות לזהות בעיות קהילתיות ולפתור אותן בטכנולוגיה.' },
  { icon: '🔬', title: 'מחקר מגדרי', text: 'מחקרים מראים: הסללה מגדרית בטכנולוגיה מתחילה בגיל חטיבת הביניים.' },
  { icon: '💜', title: 'קהילה תומכת', text: 'קבוצת עמיתות ומנטוריות שמאמינות בהן — שינוי שנשאר לכל החיים.' },
];
